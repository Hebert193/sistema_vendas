...
<form action="acoes.php" method="POST">
    ...
    <div class="form-group">
        ...
        <img src="<?= htmlspecialchars($produto->getImagemUrl()) ?>" alt="<?= htmlspecialchars($produto->getImagemUrl()) ?>">
        <input type="text" id="imagemUrl" name="imagemUrl" value="<?= htmlspecialchars($produto->getImagemUrl()) ?>" required>
    </div>
    <div class="form-group">
